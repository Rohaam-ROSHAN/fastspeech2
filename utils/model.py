...
def get_model(args, configs, device, train=False, use_bert=False):
    (preprocess_config, model_config, train_config) = configs
    
    if use_bert:
        # Load FlauBERT pre-trained model
        # modelname = '/research/crissp/SYNTHESE/_tts/_francais/_livres_sonores/flaubert/flaubert_large_cased'
        modelname = '/research/crissp/lengletm/flaubert/flaubert_base_uncased'
    ...
    if train:
        ...
        return model, scheduled_optim, flaubert, flaubert_tokenizer
